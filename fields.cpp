 ...
 * @details This file provides the storage definitions for static constexpr members
 * (OBIS IDs and PROGMEM names) declared in the corresponding `fields.h` for
 * various DSMR P1 telegram data fields. It has been modified for the
 * ESPHome dsmr_custom component to align with changes in `DEFINE_FIELD` macro.
 *
